...
@Aspect //声明一个切面
@Component
@Slf4j //lombok的注解相当于Looger....(this.class)
public class LogAspect {

    //设置切入点：这里直接拦截被@LoggerManage注解的类
    @Pointcut("@annotation(com.lsm.frame.annotation.LoggerManage)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        //判断是否包含了 无需记录日志的方法
        LoggerManage logAnno = AnnotationUtils.getAnnotation(method, LoggerManage.class);
